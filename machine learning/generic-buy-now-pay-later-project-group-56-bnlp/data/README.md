...
- Take Rate: the fee charged by the Buy Now Pay Later firm to a merchant on a transaction. That is, for each transaction made, a certain percentage is taken by the BNPL firm.
